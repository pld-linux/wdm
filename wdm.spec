...
wdm jest modyfikacją/rozszerzeniem xdm dodającym panel logowania o
większych możliwościach. Panel jest oddzielnym programem
zaimplementowanym z użyciem biblioteki widgetów WING z WindowMakera.
